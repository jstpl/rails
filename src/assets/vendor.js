...
define("DirectorRouter", (function (global) {
    return function () {
        var ret, fn;
...
wi&&(An.prototype[wi]=Xe),An}();typeof define=="function"&&typeof define.amd=="object"&&define.amd?($n._=rt, define('lodash',[],function(){return rt})):Nn?((Nn.exports=rt)._=rt,Fn._=rt):$n._=rt}).call(this);
...
define("twitterBootstrap", ["jquery"], function(){});
...
define('jrails/spa/router',['DirectorRouter'], function(DirectorRouter) {
...
define('jrails/helper/php',[],function() {
...
define('jrails/event/eventService',['jrails/helper/php'], function(phpHelper) {
...
define('jrails/helper/class',['lodash', 'jrails/helper/php'], function(_, phpHelper) {
...
define('jrails/helper/localStorage',['lodash'], function (_) {
...
define('jrails/domain/baseLocalStorage',['jrails/helper/localStorage'], function(localStorageHelper) {
...
define('jrails/kernel/container',['lodash', 'jrails/helper/class'], function(_, classHelper) {
...
define('jrails/notify/notifyTypeEnum',[],function() {
...
define('jrails/notify/notifyService',['jrails/notify/notifyTypeEnum'], function(notifyTypeEnum) {
...
;
define("toastr", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.toastr;
    };
}(this)));

define('jrails/notify/driver/toastrDriver',['lodash', 'toastr'], function(_, toastr) {
...
define('jrails/bootstrap/modal/modalService',['jquery'], function($) {
...
define('jrails/vue/vm',['lodash', 'vue'], function(_, Vue) {
...
define('jrails/spa/layer',[],function() {
...
define('jrails/spa/query',[],function() {
...
define('jrails/spa/controllerFactory',['jrails/vue/vm', 'jrails/spa/layer', 'jrails/spa/query', 'lodash'], function(vm, spaLayer, spaQuery, _) {
